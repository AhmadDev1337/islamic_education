// ignore_for_file: use_key_in_widget_constructors, library_private_types_in_public_api, prefer_const_constructors_in_immutables, prefer_const_constructors, unnecessary_this, use_build_context_synchronously, unused_field, unused_local_variable, prefer_final_fields, prefer_interpolation_to_compose_strings, avoid_unnecessary_containers, no_logic_in_create_state, depend_on_referenced_packages, prefer_const_literals_to_create_immutables
              ...
              GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => TeacherForumChatPage(
...
class TeacherForumChatPage extends StatefulWidget {
  final FirebaseFirestore firestore;
  final FirebaseAuth _auth = FirebaseAuth.instance;
  final String initialMessage;

  TeacherForumChatPage({required this.firestore, required this.initialMessage});

  @override
  _TeacherForumChatPageState createState() => _TeacherForumChatPageState();
}

class _TeacherForumChatPageState extends State<TeacherForumChatPage> {
  final TextEditingController editedContentController1 =
      TextEditingController();
  final TextEditingController editedContentController2 =
      TextEditingController();
  final TextEditingController _messageController = TextEditingController();
    ...
    if (user != null) {
      ...
      if (userSnapshot.exists) {
        setState(() {
          ...
          this.user = user; // Assign the user here
        });
      }
    }
  }
  ...
  void _deleteMessage(DocumentSnapshot message) async {
    await widget.firestore.collection('messages').doc(message.id).delete();
  }
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              Image.asset("assets/images/assisten bot.png", width: 30),
            ],
          ),
        ),
        body: Column(
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<Widget> messageWidgets = snapshot.data!.docs.map((doc) {
                    ...
                    // Determine the text color based on userRole
                    Color textColor =
                                ...
                                return <PopupMenuEntry<void>>[
                                  PopupMenuItem<void>(
                                    child: ListTile(
                                      ...
                                      onTap: () {
                                        if (userRole == 'teacher') {
                                          _copyToClipboard(originalContent);
                                        }
                                      },
                                    ),
                                  ),
  ...
  void _editMessageDialog(DocumentSnapshot message) {
    editedContentController1.text = message['content'] as String;
    editedContentController2.text = message['score'] as String;
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              TextField(
                maxLines: null,
                controller: editedContentController1,
                decoration: InputDecoration(hintText: 'Edit the content...'),
              ),
              TextField(
                controller: editedContentController2,
                keyboardType: TextInputType.number,
                decoration: InputDecoration(hintText: 'Edit the score...'),
              ),
            ],
          ),
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                await widget.firestore
                    ...
                    .doc(message.id)
                    .update({
                  'content': editedContentController1.text,
                  'score': editedContentController2.text,
                  'originalContent': message['originalContent'],
                  'sender': message['sender'],
                });

                editedContentController1.clear();
                editedContentController2.clear();
                Navigator.pop(context);
              },
              child: Text('Save'),
            ),
